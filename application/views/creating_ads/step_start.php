...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-lg-9" style="background:white;height:auto">
            ...
            <div >
                <h3>Vehicle type</h3>
                <p>On Bananacampers, every vehicle has something special.Welcome to the community!</p>
            </div>
            <div class="row">
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_1" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_1" name="type" value="Low profile"> Low profile
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_2" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_2" name="type" value="Coachbuilt"> Coachbuilt
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_3" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_3" name="type" value="‘A’ class"> ‘A’ class
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_4" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_4" name="type" value="Converted van"> Converted van
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_5" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_5" name="type" value="Camper"> Camper
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_6" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_6" name="type" value="Caravan"> Caravan
                        </div>
                    </label>
                </div>
                <div class="col-xs-6 col-sm-3 vehicle_type">
                    <label for="id_type_7" class="typelabel">
                        ...
                        <div class="typeVehicleChoice_libelle">
                            <input type="radio" id="id_type_7" name="type" value="Other"> Other
                        </div>
                    </label>
                </div>

                <div class="container change_before">
                    <a href="#" id="back_step1">Change your vehicle type</a>
                    <hr>
                    <div class="row">
                        <div class="col-xs-6">
            ...
            <div style="text-align:center">
                <hr><button class="btn btn-primary btn-lg" onclick="to_step2()">Continue</button><hr>
            </div>
        ...
        <div class="col-lg-3 rdiv">
            <div class="aside_advice aside_advicefirst">
                <h3>Welcome !</h3>
                <p> Creating a listing on Yescapa is <strong>100% free</strong>.</p>
            </div>
            <div class="aside_advice">
                <h3>Tip</h3>
                <p>To create your ad quickly and easily, use <strong>your vehicle's registration certificate</strong> to help you enter the <strong>details</strong>.</p>
            </div>
        </div>
    </div>
</div>
