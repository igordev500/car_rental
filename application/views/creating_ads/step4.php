...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-lg-9" style="background:white;height:auto">
            ...
            <div >
                <h3>Sleeping spots on the vehicle</h3>
            ...
            <span><b>Specify berth type</b></span>
            <div class="row">
                <div class="container">
                    <hr>
                    <div class="row">
            ...
            <div style="text-align:center">
                <hr><button class="btn btn-info btn-lg" onclick="back_step3()">Back</button>
                <button class="btn btn-primary btn-lg" onclick="to_step5()">Next</button><hr>
            </div>
